...
#define FILTER_CONTROL_UPDATE_MS 10000
#define ORP_CONTROL_UPDATE_MS 10000
#define ORP_REGULATION_CYCLE_MS 10*60*1000
#define PH_CONTROL_UPDATE_MS 10000
#define PH_REGULATION_CYCLE_MS 10*60*1000
