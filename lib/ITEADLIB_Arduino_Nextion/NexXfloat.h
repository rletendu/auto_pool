 ...
 * @file NexXfloat.h
 *
 * The definition of class NexXfloat. 
 *
...
#ifndef __NEXXFLOAT_H__
#define __NEXXFLOAT_H__
 ...
 * NexXfloat component.
 */
class NexXfloat: public NexTouch
{
public: /* methods */
    /**
     * @copydoc NexObject::NexObject(uint8_t pid, uint8_t cid, const char *name);
     */
    NexXfloat(uint8_t pid, uint8_t cid, const char *name);
